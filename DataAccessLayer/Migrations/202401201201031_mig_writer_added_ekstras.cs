namespace DataAccessLayer.Migrations
{
    ...
    public partial class mig_writer_added_ekstras : DbMigration
    {
        public override void Up()
        {
            AddColumn("dbo.Writers", "WritingAbout", c => c.String(maxLength: 100));
        ...
        public override void Down()
        {
            ...
            DropColumn("dbo.Writers", "WritingAbout");
        }
    }
}
